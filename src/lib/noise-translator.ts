	...
	input_schema: {
		...
		properties: {
			...
			professional_summary: {
				type: "string",
				description:
					"Short first-person paragraph to read aloud to a mechanic or technician, quoting the measured numbers exactly as given",
			},
			likely_questions: {
				type: "array",
				description:
